export default {
  ...
  ui: {
    ...
    retroLink: 'Retro-Version entdecken',
  ...
  hero: {
    ...
    tagline: 'Web · JavaScript · Produktionssysteme',
    summary:
      'Skalierbare Weblösungen mit React, Node.js und Docker — strukturiert umgesetzt, schnell in neue Systeme eingearbeitet, pragmatisch bis zum produktiven Rollout.',
  },

  profile: {
    label: 'Profil',
    title: 'Webentwicklung mit Struktur, Tiefe und Anpassungsfähigkeit',
    text: 'Softwareentwickler mit Schwerpunkt auf Webentwicklung und produktionsreifen JavaScript-Systemen. Ich setze skalierbare Lösungen mit React, Node.js, MongoDB und Docker um — von der Anforderungsanalyse über API-Design bis zum Deployment. Komplexe Systeme und fachliche Anforderungen erfasse ich schnell und übersetze sie in klare, wartbare Strukturen. Dabei verbinde ich technisches Verständnis mit Kreativität, Produktnähe und einer pragmatischen, lösungsorientierten Arbeitsweise.',
  },
  ...
  process: {
    ...
    subtitle:
      'Human-centered Softwareentwicklung — strukturiert, iterativ und mit klarem Blick auf Anforderungen, Qualität und Rollout.',
    steps: [
      {
        id: 'requirements',
    ...
    kanban: {
      ...
      columns: [
        {
          name: 'Backlog',
          tickets: ['Anforderung erfassen', 'Scope definieren', 'Technisches Konzept'],
        },
        {
          name: 'In Progress',
  ...
  skills: {
    ...
    title: 'Technischer Stack & Arbeitsweise',
    groups: [
      {
        name: 'Frontend',
      ...
      {
        name: 'Backend',
        items: ['Node.js', 'REST-APIs', 'Business-Logik', 'Datenzugriff', 'CRUD-Services'],
      },
      {
        name: 'Datenbanken',
        items: ['MongoDB', 'MySQL'],
  ...
  education: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Kaufmännische Grundausbildung im Fachhandel für Musikinstrumente.',
        areas: [],
      },
      {
        ...
        areas: ['Filmtönung', 'Musikproduktion', 'Sounddesign', 'Studioarbeit'],
      },
    ],
  },
  ...
  contact: {
    ...
    subtitle: 'Offen für Festanstellungen, Freelance-Projekte und technische Gespräche.',
